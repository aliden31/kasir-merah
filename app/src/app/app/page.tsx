...
function AppPageContent() {
  ...
  const renderView = () => {
    ...
    switch (activeView) {
      case 'erp':
        return <ErpPage onNavigate={handleNavigate} onOpenImporter={() => handleNavigate('sales-importer')} />;
      case 'dashboard':
      ...
      case 'kasir':
        return <KasirPage 
          ...
          onOpenImporter={() => handleNavigate('sales-importer')}
        />;
      case 'produk':
      ...
      default:
        return userRole === 'kasir' ? <KasirPage 
          ...
          cartItemCount={cartItemCount}
          onOpenImporter={() => handleNavigate('sales-importer')}
        /> : <ErpPage onNavigate={handleNavigate} onOpenImporter={() => handleNavigate('sales-importer')} />;
    }
  };
